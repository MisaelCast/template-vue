    ...
    <div class="register-card">
      ...
      <Transition name="slide" mode="out-in">
          ...
          >
            ...
            <div
              ...
              :class="{
                ...
                'field--ok': touched.name && !errors.name,
              }"
            >
              ...
              <div class="field-input-wrap">
                ...
                />
                <span v-if="touched.name && !errors.name" class="field-check"
                  >✓</span
                >
              </div>
            ...
            <div
              ...
              :class="{
                ...
                'field--ok': touched.email && !errors.email,
              }"
            >
              ...
              <div class="field-input-wrap">
                ...
                />
                <span v-if="touched.email && !errors.email" class="field-check"
                  >✓</span
                >
              </div>
            ...
            <div
              ...
              :class="{
                ...
                'field--ok': touched.password && !errors.password,
              }"
            >
              ...
              <div class="field-input-wrap">
                ...
                <input
                  ...
                  @input="
                    ...
                    touched.confirm && validateConfirm();
                  "
                />
                <button
                  type="button"
            ...
            <div
              ...
              :class="{
                ...
                'field--ok': touched.confirm && !errors.confirm,
              }"
            >
        ...
        <div v-else key="success" class="success-state">
          ...
          <p class="success-msg">
            Bienvenido, <strong>{{ form.name }}</strong
            >.<br />
            Tu cuenta fue registrada exitosamente.<br />Por favor verifica tu
            correo y luego inicia sesión para acceder al dashboard.
          </p>
